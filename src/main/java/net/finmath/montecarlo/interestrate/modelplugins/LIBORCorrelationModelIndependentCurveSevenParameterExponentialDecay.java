 ...
 */
public class LIBORCorrelationModelIndependentCurveSevenParameterExponentialDecay extends LIBORCorrelationModel {
    ...
    public LIBORCorrelationModelIndependentCurveSevenParameterExponentialDecay(TimeDiscretizationInterface timeDiscretization, TimeDiscretizationInterface liborPeriodDiscretization, int numberOfFactors, double[] fixedParameter, boolean isCalibrateable) {
        this(timeDiscretization, liborPeriodDiscretization, numberOfFactors, fixedParameter, new double[] {
                0.1, 0.1, 0.1, 0.1
        }, isCalibrateable);
    }

	public LIBORCorrelationModelIndependentCurveSevenParameterExponentialDecay(TimeDiscretizationInterface timeDiscretization, TimeDiscretizationInterface liborPeriodDiscretization, int numberOfFactors, double[] fixedParameter, double[] calibrationParameter, boolean isCalibrateable) {
	...
	private synchronized void initialize() {
        ...
        factorMatrix.setSubMatrix(secondFactorMatrix, timeSteps, (int)Math.ceil(0.5 * numberOfFactors));
    ...
    protected void generateCorrelationMatrices(int timeSteps, double[][] firstCurveCorrelationMatrix, double[][] secondCurveCorrelationMatrix) {
        //TODO: Seperate fixed and calibration parameters
	...
	public Object clone() {
		...
		LIBORCorrelationModelIndependentCurveSevenParameterExponentialDecay newModel = new LIBORCorrelationModelIndependentCurveSevenParameterExponentialDecay(
