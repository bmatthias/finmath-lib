 ...
 */
public class LIBORCorrelationModelTwoCurveTenParameterExponentialDecay extends AbstractLIBORCorrelationModelCombinedCurves {
    ...
    public LIBORCorrelationModelTwoCurveTenParameterExponentialDecay(TimeDiscretizationInterface timeDiscretization, TimeDiscretizationInterface liborPeriodDiscretization, int numberOfFactors, double[] fixedParameter, double[] calibrationParameter, boolean isCalibrateable) {
